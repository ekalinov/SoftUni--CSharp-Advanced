...
namespace StreetRacing
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            Car carOne = new Car("BMW", "320cd", "NFS2007", 140, 1350);
            Car carTwo = new Car("Audi", "A3", "NFS2004", 131, 1300);
            Car carThree = new Car("AudiEmo", "A3", "NFS20022", 149, 1300);
            Car carFour = new Car("Audi", "A3", "NFS20224", 151, 1300);
            Car carFive =new Car("Audi", "A3", "NFS202w24", 131, 1300);
            ...
            Console.WriteLine("----------------------------------------------------------------------");
            //GetMostPowerfulCar
            Console.WriteLine(race.FindParticipant("ssaga"));
