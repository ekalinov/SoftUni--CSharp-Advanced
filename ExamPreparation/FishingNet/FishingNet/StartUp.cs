...
namespace FishingNet
{
    public class StartUp
    {
        ...
        {// Initialize the repository (Net)
            ...
            Fish fishFou2 = new Fish("mullet", 0, 150.33);
            Fish fishFiv3e = new Fish("barbel", 21.33, -1);
            Fish fishSi4x = new Fish("trout", 35.35, 357.41);
            Fish fishSi74x = new Fish("trout", 35.45, 357.41);
            Fish fishSui4x = new Fish("trout", 35.5555, 357.41);
            Fish fishSiu4x = new Fish("trout", 35.37, 357.41);
            Console.WriteLine(net.AddFish(fishFou2));  // Successfully added salmon to the fishing net.
            Console.WriteLine(net.AddFish(fishFiv3e));  // Successfully added carfish to the fishing net.
            Console.WriteLine(net.AddFish(fishSi4x));// Successfully added bass to the fishing net. Console.WriteLine(net.AddFish(fishOne));  // Successfully added salmon to the fishing net.
            Console.WriteLine(net.AddFish(fishSui4x));// Successfully added bass to the fishing net.
            Console.WriteLine(net.AddFish(fishSiu4x));// Successfully added bass to the fishing net.
            Console.WriteLine(net.AddFish(fishSi74x));  // Successfully added carfish to the fishing net.
