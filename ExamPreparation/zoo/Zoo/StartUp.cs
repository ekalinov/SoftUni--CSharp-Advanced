...
namespace Zoo
{
    public class StartUp
    {
        ...
        {
            var zoo = new Zoo("Zoo Time", 5);
            var animaleOne = new Animal("elephant", "herbivore", 4000, 4);
            var animalTwo = new Animal("elephant", " ", 3421.25, 3.7);
            var animalThree = new Animal("sfaf", "herbivssore", 380.52, 1.9);
            var animalFour = new Animal("", "carnivore", 59.52, 1.4);
            var animalFive = new Animal("wolf", "carnivore", 65.25, 1.5);
            //var animalSix = new Animal("wolf", "carnivore", 65.255, 1.5);
            //var animalSeven= new Animal("wolf", "carnivore", 65.2555, 1.5);
           ...
           // Console.WriteLine(zoo.AddAnimal(animalSix));   // Successfully added elephant to the zoo.

            var animalByDiet = zoo.GetAnimalsByDiet("carnivore");
